const salesInvoice = Vue.component('sales-invoice', {
    template: `
        <div>
            <div class="row">
                <div class="col-xs-2">
                    <a href="" v-on:click.prevent="showDue"><i class="fa fa-print"></i> Print With Due</a>
                </div>

                <div class="col-xs-3">
                    <a href=""  v-on:click.prevent="hideDue()"><i class="fa fa-print"></i> Print Without Due</a>
                </div>
            ...
            <div id="invoiceContent">
                        ...
                        <table _a584de>
                            ...
                            <tbody>
                                <tr v-for="(product, sl) in cart">
                                    ...
                                    <td>{{ parseFloat(product.SaleDetails_Discount) }}%</td>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <br>
                        <table class="pull-left" id="hide_due">
                            <tr>
                    ...
                    <html>
                        ...
                        <body>
                            <div style="text-align:center;">
                                ...
                                <strong style="font-size:28px;">${this.currentBranch.Company_Name}</strong><br>
                    ...
                    <body>
                        <div class="row">
                            ...
                            <div class="col-xs-10" style="padding-top:20px;">
                                <strong style="font-size:8px;">${this.currentBranch.Company_Name}</strong><br>
                                <p style="white-space:pre-line;">${this.currentBranch.Repot_Heading}</p>
                            </div>
                        </div>
                        <div class="row">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="row">
                                                <div class="col-xs-2"><img src="/uploads/company_profile_thum/${this.currentBranch.Company_Logo_org}" alt="Logo" style="height:80px;" /></div>
                                                <div class="col-xs-10" style="padding-top:20px;">
                                                    <strong style="font-size:38px; color:#0e80cc !important">${this.currentBranch.Company_Name}</strong><br>
                                                    <strong style="font-size:18px;">${this.currentBranch.Company_Title}</strong><br>
                                                    <p style="white-space:pre-line;">${this.currentBranch.Repot_Heading}</p>
                                                </div>
                                            </div>
                                            <div class="row">
