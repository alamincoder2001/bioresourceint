						...
						<div class="col-sm-6">
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group">
									...
									<div class="col-xs-8">
										<input type="number" step="0.01" min="0"  name="discount" class="form-control" placeholder="discount" v-model="selectedProduct.discount" @input="productTotal" />
									</div>
								</div>
	...
	new Vue({
		...
		methods: {
			...
			productTotal() {
				...
				let total = (parseFloat(this.selectedProduct.quantity) * parseFloat(this.selectedProduct.Product_Purchase_Rate));
